...
export class MessageService {
  ...
  sendMessage(prompt: string, image?: string): void {
    ...
    this.getChatResponseStream(prompt, image).subscribe({
      next: (message) =>
  ...
  private getChatResponseStream(prompt: string, image?: string): Observable<Message> {
